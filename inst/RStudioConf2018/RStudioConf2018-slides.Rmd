...
* This document at XXXX SAY WHERE

Among other things:

- needs better parse-time diagnostics
- experience programming with `checkr` may lead to better high-level functions for simplifying checking, like `check_blanks`. 
